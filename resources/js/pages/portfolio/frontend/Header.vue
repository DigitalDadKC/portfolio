...
<template>
    <nav class="fixed z-20 w-full transition duration-500 bg-light-primary border-gray-200 dark:bg-dark-primary" :class="{'bg-light-primary dark:bg-dark-secondary border-b-2 -translate-y-3': scrollBackground, 'bg-white dark:bg-dark-primary': !scrollBackground}">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link href="/" class="flex items-center">
            <img
                ...
                :class="{'scale-80': scrollBackground, 'scale-110':!scrollBackground}"
                v-motion
                :initial="{ x: 0, y: 0 }"
            ...
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-black dark:text-white transform duration-500 mt-1 ml-2" :class="{'text-base': scrollBackground, 'text-lg':!scrollBackground}">igitalDadKC</span>
        </Link>
