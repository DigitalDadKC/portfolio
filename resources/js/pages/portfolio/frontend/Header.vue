...
<template>
    <nav class="fixed z-20 w-full transition bg-light-primary dark:bg-dark-primary"
        ...
        <div class="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <span
                class="self-center text-2xl font-semibold whitespace-nowrap text-black dark:text-white transform mt-1 ml-2"
                :class="{ 'text-base': scrollBackground, 'text-lg': !scrollBackground }">igitalDadKC</span>
            </Link>
            <button
                class="py-2 px-4 rounded-lg bg-light-quatrenary dark:bg-dark-quatrenary text-light-secondary dark:text-dark-secondary transform duration-500 cursor-pointer"
                :class="{ 'scale-100': scrollBackground, 'scale-110': !scrollBackground }" @click="toggleDark()">
            ...
            <button @click='showMobileMenu = !showMobileMenu' data-collapse-toggle="navbar-default" type="button"
                ...
                aria-controls="navbar-default" aria-expanded="false" aria-label="switch dark/light mode">
