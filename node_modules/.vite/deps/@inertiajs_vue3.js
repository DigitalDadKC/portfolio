import {
  axios_default
} from "./chunk-CSODUG5D.js";
import "./chunk-KDDPFDM7.js";
import {
  Fragment,
  computed,
  createSSRApp,
      ...
      if (!props.startElement) {
        ...
        renderElements.push(
          h(
            "div",
            { ref: startElementRef },
            slots.previous ? slots.previous(exposedPrevious) : loadingPrevious.value ? (_a = slots.loading) == null ? void 0 : _a.call(slots, exposedPrevious) : null
          )
        );
      }
      renderElements.push(
      ...
      if (!props.endElement) {
        ...
        renderElements.push(
          h(
            "div",
            { ref: endElementRef },
            slots.next ? slots.next(exposedNext) : loadingNext.value ? (_c = slots.loading) == null ? void 0 : _c.call(slots, exposedNext) : null
          )
        );
      }
